        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav ms-auto">
                    @if (auth()->user()->isMedecin() || auth()->user()->isCh() || auth()->user()->isAdmin() || auth()->user()->isMedecin())
                        <li class="nav-item">
                            <a class="text-white nav-link" href="{{ route('backoffice.dashboard') }}">Tableau de
                                bord</a>
                        </li>
                    @endif
...
<nav class="shadow-sm navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        ...
        <div class="text-white ms-auto d-flex align-items-center">
            <span class="me-3">
